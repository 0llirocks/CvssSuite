...
namespace Cvss.Suite.Tests
{
    ...
    public class Cvss2
    {
        ...
        [DataTestMethod]
        [DataRow("AV:")]
        [DataRow("AV:L/AC:Z/Au:M/C:P/I:N/A:N")]
        public void InvalidCvss2Vectors(string vector)
        {
            var cvss = Cvss.Suite.CvssSuite.Create(vector);
        ...
        [DataTestMethod]
        [DataRow("Access Vector", "Local")]
        [DataRow("Access Complexity", "High")]
        [DataRow("Authentication", "Multiple")]
        [DataRow("Confidentiality Impact", "Partial")]
        [DataRow("Integrity Impact", "None")]
        [DataRow("Availability Impact", "Complete")]
        [DataRow("Invalid", "")]
        public void SelectedCvss2Metric(string metric, string selectedMetric)
        {
            var cvss = Cvss.Suite.CvssSuite.Create("AV:L/AC:H/Au:M/C:P/I:N/A:C");
